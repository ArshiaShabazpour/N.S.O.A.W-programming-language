...
class Concatenation(
    ...
    override fun eval(runtime: Runtime): Data {
        ...
        val leftStr = when (leftEval) {
            ...
            is FloatData -> leftEval.value.toString()
            is DoubleData -> leftEval.value.toString()
            is BooleanData -> leftEval.value.toString()
        ...
        val rightStr = when (rightEval) {
            ...
            is FloatData -> rightEval.value.toString()
            is DoubleData -> rightEval.value.toString()
            is BooleanData -> rightEval.value.toString()
            else -> throw Exception("Unsupported data type for concatenation")
        }
